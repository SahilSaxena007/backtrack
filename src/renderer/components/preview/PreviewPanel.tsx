  ...
  const content = (
    <AnimatePresence>
      {mode === 'panel' && plan && (
        ...
        >
          <motion.div
            className="flex h-[83vh] w-[86vw] max-w-[86vw] flex-col rounded-2xl border border-slate-700/80 bg-slate-900/80 text-white shadow-[0_10px_30px_rgba(2,6,23,0.2)]"
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-700/80 bg-slate-900/70 px-6 py-3">
            ...
            <div className="flex flex-1 flex-col gap-4 px-6 py-4">
              <div className="grid flex-1 grid-cols-1 gap-4 lg:grid-cols-2">
                <div className="flex min-h-0 flex-col rounded-2xl border border-slate-600/85 bg-slate-800/88">
                ...
                <div className="relative flex min-h-0 flex-col rounded-2xl border border-slate-600/85 bg-slate-800/88">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-700/80 bg-slate-900/70 py-3">
